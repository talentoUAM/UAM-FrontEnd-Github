...
const About = () => {
    ...
    useEffect(() => {
        ...
        if (!pageAboutData || !pageAboutBlocks || !pageAboutTeamData || !pageAboutTeamMembersData || !pageAboutTeamColaboratorsData ) {
            setIsLoading(true);
    ...
    }, [pageAboutData, pageAboutBlocks, pageAboutTeamData, pageAboutTeamMembersData, pageAboutTeamColaboratorsData]);
