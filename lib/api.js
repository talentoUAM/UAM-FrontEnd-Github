...
export const fetchMenu = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/menus?locale=${lang}`;
  try {
...
export const fetchFooterSections = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/footer-sections?locale=${lang}`;
  try {
    return await fetchWithCache(url);
  } catch (error) {
...
export const fetchFooterPanels = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/footer-panels?locale=${lang}`;
  try {
...
export const fetchFooterLaUam = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/footer-la-uams?locale=${lang}`;
...
export const fetchFooterLaVidaUni = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/footer-vida-universitarias?locale=${lang}`;
...
export const fetchFooterInformacion = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/footer-informacions?locale=${lang}`;
...
export const fetchPageContact = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-contact?locale=${lang}`;
...
export const fetchPageLegalNotice = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-legal-notice?locale=${lang}`;
...
export const fetchFooterLegalMenu = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/footer-legal-menus?locale=${lang}`;
...
export const fetchPageCookies = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-cookie?locale=${lang}`;
...
export const fetchPagePrivacyPolicy = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-privacy-policy?locale=${lang}`;
...
export const fetchPagePrivacyPolicyContent = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/privacy-policy-contents?locale=${lang}`;
...
export const fetchPageAccessibility = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-accessibility?locale=${lang}`;
...
export const fetchCookiesPolicyPopUp = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/pop-up-cookies-policy?locale=${lang}`;
...
export const fetchHomeHeroSection = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/home-hero-section?locale=${lang}`;
...
export const fetchHomeHeroDownloadSection = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/home-hero-download-section?locale=${lang}&populate=*`;
...
export const fetchHomeTileSection = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/home-title-section?locale=${lang}`;
...
export const fetchHomeAboutSection = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/home-about-section?locale=${lang}`;
...
export const fetchPressReleases = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/press-releases?locale=${lang}&populate=*`;
...
export const fetchPosts = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/posts?locale=${lang}&populate=*`;
...
export const fetchCategories = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/news-categories?locale=${lang}&populate=*`;
...
export const fetchPagePost = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-post?locale=${lang}&populate=*`;
...
export const fetchPostById = async (id, locale) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/posts/${id}?locale=${locale}&populate=*`;
...
export const fetchHomeCifrasTalento = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/home-cifra-talentos`;
...
export const fetchPageAbout = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-about?locale=${lang}&populate=*`;
...
export const fetchPageAboutBlocks = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-about-blocks?locale=${lang}&populate=*`;
...
export const fetchPageAboutTeam = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-about-teams?locale=${lang}&populate=*`;
...
export const fetchPageAboutMembers = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-about-members?locale=${lang}&populate=*`;
...
export const fetchPageAboutColoborators = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-about-colaborators?locale=${lang}&populate=*`;
...
export const fetchPageResearch = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-research?locale=${lang}&populate=*`;
...
export const fetchResearchLines = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/research-lines?locale=${lang}&populate=*`;
...
export const fetchResearchFeatures = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/research-features?locale=${lang}&populate=*`;
...
export const fetchResearchPublications = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/research-scientific-publications?locale=${lang}&populate=*`;
...
export const fetchResearchTesis = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/research-teses?locale=${lang}&populate=*`;
...
export const fetchPageTraining = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-training?locale=${lang}&populate=*`;
...
export const fetchPageTrainingProgram = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-training-programs?locale=${lang}&populate=*`;
...
export const fetchPageTrainingPostgrade = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-training-postgrades?locale=${lang}&populate=*`;
...
export const fetchPageTransfer = async (lang) => {
  const url = `${process.env.NEXT_PUBLIC_STRAPI_URL}/api/page-transfer?locale=${lang}&populate=*`;
